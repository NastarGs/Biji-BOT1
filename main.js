...
global.owner = [6283820699650] // Put your number here
global.mods = [6283820699650] // Want some help?
global.prems = [6283820699650] // Premium user has unlimited limit
    ...
    let user = global.DATABASE._data.users[m.sender]
      ...
      let _prefix = plugin.customPrefix ? plugin.customPrefix : conn.prefix ? conn.prefix : global.prefix
        ...
        try {
          ...
          if (m.limit) m.reply(+ m.limit + ' Limit terpakai, ojo nafsu karo fitur bot e yoo hehe')
        }
  			break
  		}
  	}
